...
- Trial credits can be used across any agent on the platform
- Once trial credits are depleted, users need to purchase credits to continue
...
<Warning>
Pactory charges a 10% platform fee on all paid transactions. For example:
- Transaction total: 1000 credits
- Platform fee (10%): 100 credits
- Your earnings: 900 credits
</Warning>
