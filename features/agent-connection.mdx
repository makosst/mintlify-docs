...
<Note>
Important: Your agent needs to be turned on before it can process any requests. You can toggle the agent's status using the activation switch in My Agents dashboard.
</Note>
