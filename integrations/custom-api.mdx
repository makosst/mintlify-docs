...
<Note>
Your API endpoint must handle the request format specified above and return responses in the expected format. Token usage tracking is optional but recommended for accurate billing.
</Note>
